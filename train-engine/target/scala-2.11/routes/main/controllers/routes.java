...
public class routes {
  ...
  public static final controllers.ReverseNewEnvironmentController NewEnvironmentController = new controllers.ReverseNewEnvironmentController(RoutesPrefix.byNamePrefix());
  ...
  public static final controllers.ReverseAggregateAnalysisController AggregateAnalysisController = new controllers.ReverseAggregateAnalysisController(RoutesPrefix.byNamePrefix());
  ...
  public static final controllers.ReverseStartTestController StartTestController = new controllers.ReverseStartTestController(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseNewEnvironmentController NewEnvironmentController = new controllers.javascript.ReverseNewEnvironmentController(RoutesPrefix.byNamePrefix());
    ...
    public static final controllers.javascript.ReverseAggregateAnalysisController AggregateAnalysisController = new controllers.javascript.ReverseAggregateAnalysisController(RoutesPrefix.byNamePrefix());
    ...
    public static final controllers.javascript.ReverseStartTestController StartTestController = new controllers.javascript.ReverseStartTestController(RoutesPrefix.byNamePrefix());
