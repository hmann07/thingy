class App extends React.Component {
 ...
 runClickHandle(runData) {
  ...
  $.get( "/generations/" + runData.runId, function( generationData ) {
    t.setState({generationData : generationData, currentRunId : runData.runId, currentRunSettings: JSON.stringify(runData.settings)})
  })  
 ...
 render(){
 	return (
      ...
      React.createElement(DataSelector, {value: this.state.runData, fields: ["runId","startTime", "endTime", "duration"], clickHandler: this.runClickHandle.bind(this)}), "", 
